...
public class EditAccountController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (userId == null || accountTypeId == null) {
                response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Missing user_id or account_type_id");
                return;
            }

            Map<String, Object> accountDetails = editAccountService.getAccountDetails(userId, accountTypeId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ("closeAccount".equals(action)) {
                if (editAccountService.closeAccount(userId, accountTypeId)) {
                ...
                } else if (editAccountService.updateAccount(userId, accountTypeId, newAccountTypeId, nickname)) {
    ...
    /**
     * Maps account type name to account_type_id.
     * This is a placeholder; in a real app, this would query the account table.
     *
